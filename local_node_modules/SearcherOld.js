...
var search = function(terms)
{
    ...
    request({
        ...
        if (!error && response.statusCode === 200)
        {
            ...
            var publications=[];
            var completedRequestsObject = {completedRequests : 0};
            for(var i=0; i < idlist.length; i++)
            {
                getDetails(idlist[i], publications, completedRequestsObject, idlist.length);
            }
        }
        else
        {
...
var getDetails = function(id, publications, completedRequestsObject, length)
{
    ...
    (
        ...
        function (error2, response2, body2)
        {
            if (!error2 && response2.statusCode === 200)
            {
                ...
                {
                    authors.push(objectAuthors[j].LastName[0]+" "+objectAuthors[j].ForeName[0]);
                }
                ...
                {
                    console.info("Providing Pubmed details finished");
                    /*
                    console.info("Searching urls on Google Scholar...");
                    getURL(publications, completedRequestsObject, length);
                    */
                }
            }
            else
