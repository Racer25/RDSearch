...
var Publication = require("../model/MostCitedPublication.js");

var search = function(terms, res, callback)
{
    console.info("Searching publications ids...");
    var url = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=100&term=("+terms
        +" AND hasabstract[text] AND Humans[Mesh])&retmode=json"
    ...
    request({
        ...
        if (!error && response.statusCode === 200)
        {
            ...
            async.eachLimit(idlist, 3, function (id, next) {
                setTimeout(function() {
