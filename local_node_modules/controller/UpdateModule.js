...
var noUpdateRareDiseaseWorkflow = function()
{
    ...
    RareDiseaseDao.getRareDiseases(
        ...
        function(results)
        {
            ...
            //results = results.filter(function(currentValue, index, arr){return currentValue.orphanetID == "98538"});
...
var updateSymptoms = function(idList, orphanetID, symptoms, symptomsDetectedWithWeight, callback)
{
    ...
    console.log("callNCBIAPI getPublications, disease: "+orphanetID);
    NCBIAPIModule.callNCBIAPI(
        ...
        [
            ...
            {
                console.log("Publications reçues: ");
