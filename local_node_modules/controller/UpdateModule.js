...
var updateSymptoms = function(publication, orphanetID, callback)
{
        ...
        function(symptomsWithOccurrence)
        {
            async.each(
                ...
                function(err)
                {
                    if(err)
                    {
                        console.error("Error updating Symptoms");
                    }
                    else
                    {
                        console.info("Update of Symptoms finished");
                    }
                }
            );
        }
