...
var TextMiningModule = require("../controller/TexMiningModule.js");
...
var updateSymptoms = function(idList, orphanetID, symptoms, callback)
{
    async.each(
        idList,
        function(id, next2)
                ...
                [
                    ...
                    function(publication)
                    {
                        TextMiningModule.giveSymptomsWithOccurrence(
                            ...
                            {
                                var symptomsWithOccurrenceBis =symptomsWithOccurrence.slice();
                                ...
                                async.each(
                                    ...
                                    function(err)
                                    {
                                        if(err)
                                        {
                                            console.error("Error updating Symptoms of publication: "+publication.idPublication);
                                        }
                                        else
                                        {
                                            console.info("Update of Symptoms of of publication: "+publication.idPublication+" finished");
                                            next2();
                                        }
                                    }
                                );
        ...
        function(err)
        {
            ...
            {
                console.info("Update of all Symptoms of disease "+ orphanetID +" finished");
                callback();
            }
        }
    );
...
exports.getSymptomsFromFile=getSymptomsFromFile;