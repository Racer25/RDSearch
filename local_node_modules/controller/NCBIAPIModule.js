...
var getIdsFromSearch = function(searchString, orphanetID, callback)
{
    ...
    pubmed.esearch(
        ...
        function(err, response, data)
        {
            ...
            console.log("Response from getIdsFromSearch, searchString="+searchString+", orphanetID="+orphanetID);
...
var getNumberPublicationsThatCiteGivingPublications = function(idList, callback)
{
    ...
    var url="https://eutils.ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?dbfrom=pubmed&linkname=pubmed_pubmed_citedin&retmode=json";
