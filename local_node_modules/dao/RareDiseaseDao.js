...
var addOrModifyRareDisease = function(rareDisease, callback)
{
    ...
    var sql = "INSERT INTO rareDisease(orphanetID, name, numberPublications) "+
        "VALUES(?, ?, ?) ON DUPLICATE KEY "+
        "UPDATE name=?, numberPublications=?";
    var inserts = [rareDisease.orphanetID, rareDisease.name, rareDisease.numberPublications, rareDisease.name, rareDisease.numberPublications];
