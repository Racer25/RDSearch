...
{
    var connection=ConnectionProvider.getConnection();
    var sql = "INSERT INTO textualInformation(idTextualInformation, title, content, orphanetID, sourceName, sourceLink) "+
        "VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY "+
        "UPDATE title=?, content=?, orphanetID=?, sourceName=?, sourceLink=?";
    var inserts = [textualInformation.id,
        textualInformation.title, textualInformation.content,
        textualInformation.orphanetID, textualInformation.sourceName, textualInformation.sourceLink,
        textualInformation.title, textualInformation.content,
        textualInformation.orphanetID, textualInformation.sourceName, textualInformation.sourceLink];
    sql = mysql.format(sql, inserts);
